...
<html lang="en">
    ...
    ?>
        ...
        <div class="grid grid-cols-8 p-1">

            <div class="bg-white rounded-md shadow-md p-2">
                
                <div class="font-black text-lg mb-12 mt-2">
                    <h1>Computer World</h1>
                </div>

                <div class="font-bold">
                    <a href=""><h1>Features</h1></a>
                    <a href=""><h1>Testemonials</h1></a>
                </div>
            ...
            <div class="bg-white rounded-md shadow-md col-span-7 ml-1">
                <section class="">
